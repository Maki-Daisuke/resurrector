<script lang="ts">
  ...
  // Case-insensitive comparator for string values; falls back to default
  // comparison for non-strings (numbers, booleans, null/undefined).
  function caseInsensitiveComparator(a: unknown, b: unknown): number {
